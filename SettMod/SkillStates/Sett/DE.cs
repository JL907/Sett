...
{
    public class SuperDededeJump : GenericCharacterMain
    {
        ...
        public override void HandleMovements()
        {
            if (!this.hasDropped)
            {
                ...
                base.characterMotor.rootMotion += this.flyVector * ((0.8f * this.moveSpeedStat) * EntityStates.Mage.FlyUpState.speedCoefficientCurve.Evaluate(base.fixedAge / SuperDededeJump.jumpDuration) * Time.fixedDeltaTime);
