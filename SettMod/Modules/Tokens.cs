...
namespace SettMod.Modules
{
    internal static class Tokens
    {
        ...
        internal static void AddTokens()
        {
            ...
            LanguageAPI.Add("SETT_UTILITY_DESC", "Sett <color=#c9aa71>carries</color> an enemy through the air and slams them into the ground, dealing <color=#f68835>1600%</color> <color=#d62d20>(+7.5% of primary target's combined maximum health and maximum shield)</color> damage to all enemies near where they land.");
