...
namespace SettMod.Modules
{
    internal static class Skills
    {
        ...
        internal static void CreateSkillFamilies(GameObject targetPrefab)
        {
            ...
            skillLocator.passiveSkill.skillDescriptionToken = "Sett <color=#c9aa71>regenerates</color> an additional <color=#008744>1 health per second</color> for every <color=#f68835>5%</color> of his <color=#d62d20>missing health.</color>";
