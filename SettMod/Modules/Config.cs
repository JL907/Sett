...
namespace SettMod.Modules
{
    public static class Config
    {
        ...
        {
            baseHealth = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Base Health"), 186f, new ConfigDescription("", null, Array.Empty<object>()));
            healthGrowth = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Health Growth"), 46f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            regenGrowth = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Health Regen Growth"), 0f, new ConfigDescription("", null, Array.Empty<object>()));
            baseArmor = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Base Armor"), 33f, new ConfigDescription("", null, Array.Empty<object>()));
            armorGrowth = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Armor Growth"), 3.7f, new ConfigDescription("", null, Array.Empty<object>()));
            baseDamage = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Base Damage"), 15f, new ConfigDescription("", null, Array.Empty<object>()));
            damageGrowth = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Damage Growth"), 2.4f, new ConfigDescription("", null, Array.Empty<object>()));
            baseMovementSpeed = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("01 - Character Stats", "Base Movement Speed"), 7f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            leftPunchDamageCoefficient = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("02 - Kunckle Down", "Kunckle Down Left Punch Damage Coefficient"), 3.5f, new ConfigDescription("", null, Array.Empty<object>()));
            leftPunchDamageCoefficient = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("02 - Kunckle Down", "Kunckle Down Right Punch Damage Coefficient"), 5f, new ConfigDescription("", null, Array.Empty<object>()));

            faceBreakerDamageCoefficient = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("03 - Face Breaker", "Face Breaker Damage Coefficient"), 8f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            faceBreakerCD = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("03 - Face Breaker", "Face Breaker Cooldown"), 6f, new ConfigDescription("", null, Array.Empty<object>()));
            ...
            bonusHealthCoefficient = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("04 - The Show Stopper", "The Show Stopper Bonus Damage Coefficient"), 0.1f, new ConfigDescription("Bonus Damage Based On Primary Target Maximum Health Coefficient", null, Array.Empty<object>()));
            ...
            slamForce = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("04 - The Show Stopper", "The Show Stopper Slam Force"), 2000f, new ConfigDescription("", null, Array.Empty<object>()));
            slamCD = SettPlugin.instance.Config.Bind<float>(new ConfigDefinition("04 - The Show Stopper", "The Show Stopper Cooldown"), 8f, new ConfigDescription("", null, Array.Empty<object>()));
