...
namespace SettMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            SettPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            SettPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            SettPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
        ...
        private static void SetupKinematicCharacterMotor(GameObject prefab)
        {
            ...
            kinematicCharacterMotor._attachedRigidbody = prefab.GetComponent<Rigidbody>();
            ...
            kinematicCharacterMotor.CheckMovementInitialOverlaps = false;
        }
